        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="main-menu text-center">
                        <nav>
                            <ul id="slick-nav">
                                ...
                                <li><a class="scroll" href="#token">Tokenomics</a></li>
                                <li><a class="scroll" href="#roadmap">Roadmap</a></li>
                                <!--<li><a class="scroll" href="#team">Team</a></li>-->
                                <li><a class="scroll" href="#apps">Telegram</a></li>
                ...
                <div class="col-4 col-lg-2 text-right">
                    <a href="#" class="logibtn gradient-btn">Community</a>
                </div> 
            ...
            <div class="row">
                <div class="col-12 col-md-6 align-self-center">
                    <div class="welcome-right">
                        <div class="welcome-text">
                             <h1>JUNGLECOIN is a Crypto Token into Charity</h1><br>
                             <h5> That's a Token with a Purpose We are a sustainable and decentralized project that distributes wealth where it needs to be</h5>
                             <p> JungleCoin is a community-run charity cryptocurrency project, on the blockchain after months of ground work by an all volunteer
                              team rescue revitalize, and rebrand the abandoned grumpy finance project supporting.</p>
                            </div>
                        <div class="welcome-btn">
                            <a href="#wallet" class="gradient-btn v2 mr-20">Airdrop</a>
                            <a href="#" class="gradient-btn v2">Buy now</a>
                            <br>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="welcome-img">
                        ...
                        <br>
                        <br>
                        <img src="assets/img/bg_jcoin.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="distibution-d item-1">
                            <ul>
                                <li class="distibution-list-1"><span>6% </span>Reward for Holders & Burn</li>
                                <li class="distibution-list-2"><span>80% </span>ICO Investors</li>
                                <li class="distibution-list-3"><span>4% </span>Branding & Marketing</li>
                                <li class="distibution-list-4"><span>10% </span>Charity </li>
                            </ul>
                        </div>
                    </div>
                </div>
